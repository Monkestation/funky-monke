...
def process_git_log_output(output, author_timestamps):
    ...
    for line in output.splitlines():
        ...
        # Add main author
        if author_name and author_email and author_name.strip() != "Unknown" and author_name.strip().lower() != "PLACEHOLDERBOTNAME":
        ...
        for match in co_author_regex.finditer(body):
            ...
            if co_author_name and co_author_email and co_author_name.strip() != "Unknown" and co_author_name.strip().lower() != "PLACEHOLDERBOTNAME":
